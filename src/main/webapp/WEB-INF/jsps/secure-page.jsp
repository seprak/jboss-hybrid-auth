...
pageContext.setAttribute("otherPageId", (pageId.equals("RAP") ? "CISL" : "RAP"));
%>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body class="container py-4">
    ...
    <c:if test="${!empty sessionScope['cee.allianz.abs.oidc.authorization']}">
      <div class="row">
        <div class="col">
          <h2>Authorization</h2>
          <p>This is authorization information from the OP made available to the application in the HTTP session.</p>
          <pre><c:out value="${sessionScope['cee.allianz.abs.oidc.authorization']}"/></pre>
        </div>
      </div>
    </c:if>
    <div class="row">
      <div class="col">
        ...
        <ul>
          ...
          <li><a href="page-${otherPageId}"><c:out value="Secure Page ${otherPageId}"/></a></li>
